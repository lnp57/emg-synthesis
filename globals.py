...
# global_path = "D:/Research/data_temp/"
# global_path ="C:/Users/yamag/Box/$M gesture recognizer data/" #"D:/Box Sync/$M gesture recognizer data/"
...
# CHI 2024
pIDs = ['P102','P103','P104','P105','P106','P107','P108','P109','P110','P111',
...
time_features_EMG = [MAV,STD,Var,WL,ZC,NP,MPV,SSC,
                 DAMV,MFL,Skew,iav,HMob,DASDV,WAM,Kurt,MDF,FR,PKF]
corr_features_EMG = [Cor]
freq_features_EMG = [WL,MPV]

time_features_IMU = [MAV,WL]